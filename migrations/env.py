...
# Only fall back to Settings' database_url when the caller hasn't already set
# one on the Config object (conftest.py's `engine` fixture points this at
# TEST_DATABASE_URL before calling command.upgrade; don't clobber that).
